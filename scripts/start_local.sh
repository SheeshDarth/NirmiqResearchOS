...
export USE_OLLAMA_GENERATION="${USE_OLLAMA_GENERATION:-false}"
export USE_OLLAMA_EMBEDDINGS="${USE_OLLAMA_EMBEDDINGS:-false}"
export USE_OLLAMA_RERANKER="${USE_OLLAMA_RERANKER:-false}"
